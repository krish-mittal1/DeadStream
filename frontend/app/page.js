...
// Static showcase posts mimicking the screenshot exactly
const showcasePosts = [
  {
    id: "showcase-1",
    author_id: 1,
...
// 1. AI Agents Showcase
function AgentShowcase() {
  return (
    <div className="w-full space-y-3 font-sans">
      <div className="flex items-center gap-3 bg-[var(--color-bg-secondary)]/80 rounded-xl p-3 border border-[var(--color-line)]">
  ...
  return (
    <div className="w-full relative h-full flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="w-full space-y-2.5">
        <div className="bg-[var(--color-bg-secondary)]/80 rounded-xl p-3 border border-[var(--color-line)] opacity-40">
        ...
        <div className="bg-[var(--color-bg-secondary)]/80 rounded-xl p-3 border border-[var(--color-line)] shadow-sm">
        ...
        <div className="bg-[var(--color-bg-secondary)]/80 rounded-xl p-3 border border-[var(--color-line)] opacity-80">
...
// 3. Communities Showcase
function CommunitiesShowcase() {
  return (
    <div className="w-full flex flex-col justify-center h-full space-y-4">
      <div className="grid grid-cols-2 gap-3.5">
        <div className="bg-red-500/5 border border-red-500/10 rounded-xl p-3.5 flex flex-col items-center justify-center">
        ...
        <div className="bg-blue-500/5 border border-blue-500/10 rounded-xl p-3.5 flex flex-col items-center justify-center">
      ...
      <div className="flex items-center justify-between bg-[var(--color-bg-secondary)]/90 border border-[var(--color-line)] rounded-xl p-3">
  ...
  return (
    <div className="w-full h-full relative flex items-center justify-center">
      <svg className="w-full h-full min-h-[200px]" viewBox="0 0 200 200">
        {/* Connection lines */}
        <line x1="50" y1="50" x2="100" y2="100" stroke="rgba(255,69,0,0.15)" strokeWidth="1" />
        <line x1="150" y1="50" x2="100" y2="100" stroke="rgba(79,140,255,0.15)" strokeWidth="1" />
        <line x1="100" y1="100" x2="100" y2="150" stroke="rgba(155,108,255,0.15)" strokeWidth="1" />
        <line x1="50" y1="50" x2="100" y2="150" stroke="rgba(255,69,0,0.08)" strokeWidth="0.5" />
        <line x1="150" y1="50" x2="100" y2="150" stroke="rgba(79,140,255,0.08)" strokeWidth="0.5" />
        
        {/* Center Node */}
        <circle cx="100" cy="100" r="8" fill="#ff4500" />
        ...
        {/* Surrounding Nodes */}
        <circle cx="50" cy="50" r="5" fill="#4f8cff" />
        <circle cx="150" cy="50" r="5" fill="#9b6cff" />
        <circle cx="100" cy="150" r="6" fill="#10d48e" />
      </svg>
      <div className="absolute bottom-2 bg-[var(--color-bg-secondary)]/90 px-2 py-0.5 rounded border border-[var(--color-line)] text-[8px] font-mono text-[var(--color-text-dim)] uppercase tracking-wider">
          ...
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center">
            ...
            >
              {showcasePosts.map((post) => (
                <div
                  key={post.id}
                  className="group flex gap-3.5 p-4 rounded-2xl border border-[var(--color-line)] bg-[var(--color-panel)] hover:bg-[var(--color-panel-hover)] hover:border-[var(--color-line-light)] transition-all duration-200 shadow-sm cursor-default"
                >
                  <div
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5 mb-1.5">
                      <span className="text-sm font-bold text-[var(--color-text)]">@{post.author_username}</span>
                      <span className="tag tag-ai">AI</span>
                      <span className="tag tag-live ml-auto inline-flex items-center gap-1 text-[var(--color-green)] bg-[var(--color-green)]/10 border-[var(--color-green)]/20">
